...
#Region "Private Function Get Est Price"
    '## 12/7/2007   (yang)
    Public Function GetRate(ByVal PriceTable As String, ByVal PuCounty As String, ByVal PuCity As String, ByVal PuStName As String, ByVal PuPriceZone As String, _
            ByVal DestCounty As String, ByVal DestCity As String, ByVal DestStName As String, ByVal DestPriceZone As String) As Double
        ...
        Try
            ...
            With Me.Command
                ...
                .CommandText = "apex_geo_getrate"
                .Parameters.Clear()

                .Parameters.AddWithValue("@pu_county", PuCounty)
                .Parameters.AddWithValue("@pu_city", PuCity)
                .Parameters.AddWithValue("@pu_st_name", PuStName)
                .Parameters.AddWithValue("@pu_price_zone", PuPriceZone)

                .Parameters.AddWithValue("@dest_county", DestCounty)
                .Parameters.AddWithValue("@dest_city", DestCity)
                .Parameters.AddWithValue("@dest_st_name", DestStName)
                .Parameters.AddWithValue("@dest_price_zone", DestPriceZone)

                .Parameters.AddWithValue("@pricing_table", PriceTable)

                .Parameters.Add("@rate", SqlDbType.SmallInt)
                .Parameters.Item("@rate").Direction = ParameterDirection.Output

                .ExecuteNonQuery()

                rate = Val(Convert.ToString(.Parameters.Item("@rate").Value))
            End With
    ...
    Function get_price(ByVal strAcctId As String, ByVal strSubAcctId As String, ByVal strCompany As String, _
        ...
        Const WEB_DISCOUNT As Single = 0.0
        ...
        Dim Ds As DataSet
        '--Comments no min_price_by_mileage,min_base_rate columns .
        ...
        Else
            ...
            '-- 8/16/02
            sngAM_Holiday_Surcharge = 0.0
            sFrom_AM_Holiday_Surcharge = 0.0
            sTo_AM_Holiday_Surcharge = 0.0
            '-- 3/20/03
            sngAM_Holiday_Surcharge2 = 0.0
            sFrom_AM_Holiday_Surcharge2 = 0
            sTo_AM_Holiday_Surcharge2 = 0
    ...
    Function get_call_city_to_city_pricing(ByVal pr_book As Integer, ByVal ss_cmbPuCounty As String, ByVal txtPuCountyTrue As String, ByVal ss_cmbPuCity As String, ByVal ss_cmbDestCounty As String, ByVal txtDestCountyTrue As String, ByVal ss_cmbDestCity As String, ByVal ss_cmbCompany As Integer, ByVal ss_cmbAccountNo As String, ByVal ss_cmbSubAccountNo As String, ByVal txtPuPriceZone As String, ByVal txtDestPriceZone As String, ByRef bFoundInPriceTable As Boolean, ByRef fp_curTolls As Single) As String
        ...
        If Trim(CStr(txtPuPriceZone)) <> "" And Trim(txtDestPriceZone) <> "" Then
            sql_string = "select price from price(NOLOCK) where table_id = " & pr_book & " and from_zone like  '%" & sqlsafe(txtPuPriceZone) & "' and to_zone like '%" & sqlsafe(txtDestPriceZone) & "'"
            ...
            Else
                dr_gcctcp.Dispose()
                dr_gcctcp = Nothing
                sql_string = "select price from price(NOLOCK) where table_id = " & pr_book & " and from_zone like '%" & sqlsafe(txtDestPriceZone) & "' and to_zone like '%" & sqlsafe(txtPuPriceZone) & "'"
                dr_gcctcp = Me.QueryData(sql_string, "price")
                If dr_gcctcp.Tables("price").Rows.Count > 0 Then
...
#Region "Price Page Search Module Function"
    ...
    Public Function isairport(ByVal statecode As String) As Boolean
        ...
        StrSql = "exec APEX_wr_is_airport '" & objSecurity.SQLSafe(statecode) & "'"
    ...
    Public Function GetCityName_Zone(ByVal strcity As String, ByVal strstate As String, ByRef GetCity_Zone As DataSet) As String
        ...
        strsql = "exec APEX_wr_query_city_state_zone '" & objSecurity.SQLSafe(strcity) & "','" & objSecurity.SQLSafe(strstate) & "'"
            ...
            If DS.Tables.Count > 0 Then
                If DS.Tables(0).Rows.Count > 0 Then
                    If DS.Tables(0).Rows.Count > 1 Then
                        GetCity_Zone = DS
                        GetCityName_Zone = objSecurity.Check_DBNULL(DS.Tables(0).Rows(0).Item("pricing_zone"))
                    Else
    ...
    Public Function GetByblur_city_State(ByVal strcity As String, ByVal strstate As String) As DataSet
        ...
        strsql = "exec APEX_wr_query_city_state_blur_zone '" & objSecurity.SQLSafe(strcity) & "','" & objSecurity.SQLSafe(strstate) & "'"
        'strsql = "select name,county,state,price_zone from city(nolock) where ltrim(rtrim(name)) like '" & Trim(strcity) & "%' order by name,state,county"
    ...
    Public Function Get_Price_Zone(ByVal strcity As String, ByVal strstate As String) As DataSet
        ...
        strsql = strsql & " where ltrim(rtrim(name)) like '" & objSecurity.SQLSafe(strcity) & "%' and ltrim(rtrim(state))='" & objSecurity.SQLSafe(strstate) & "'"
    ...
    Public Function GetCityName(ByVal strcity As String) As DataSet
        ...
        strsql = "exec APEX_wr_query_city_state '" & objSecurity.SQLSafe(strcity) & "'"
        'strsql = "select name,county,state,price_zone from city(nolock) where ltrim(rtrim(name)) like '" & Trim(strcity) & "%' order by name,state,county"
    ...
    Public Function SearchAirport_ByName(ByVal strname As String) As DataSet
        ...
        Return Me.QueryData("exec APEX_wr_query_airport_by_aleph '" & objSecurity.SQLSafe(strname) & "'", "SearchAirport_ByName")
...
#Region "Geo Get Price_Zone Function"
    ...
    Public Function GetPriceZone(ByVal strcity As String, ByVal strCounty As String, ByVal strstate As String, ByVal strpricetable As String, ByRef Dispatch_zone As Int16) As String
        ...
        If Not objdataset Is Nothing Then
            If objdataset.Tables.Count > 0 Then
                If objdataset.Tables(0).Rows.Count > 0 Then
                    Dim iCount As Int32 = objdataset.Tables(0).Rows.Count - 1
                    Dim i As Int32
                    For i = 0 To iCount

                        price_counter = objdataset.Tables(0).Rows(i).Item("pricing_table_counter").ToString
                        Dispatch_zone = Convert.ToInt16(objdataset.Tables(0).Rows(i).Item("dispatch_zone"))

                        Dim objDataSetPriceZone As New DataSet
                        ...
                        objDataSetPriceZone = Me.QueryData(strsql, "cityname")

                        If objDataSetPriceZone.Tables(0).Rows.Count > 0 Then
                            GetPriceZone = objDataSetPriceZone.Tables(0).Rows(0).Item("pricing_zone").ToString
                            objDataSetPriceZone.Dispose()
                            objDataSetPriceZone = Nothing
                            Exit For
                        Else
                            GetPriceZone = ""
                        End If
    ...
    '## 12/6/2007   (yang)
    Public Function GetPriceZone(ByVal PriceTable As String, ByVal County As String, ByVal City As String, ByVal StName As String, ByVal StNo As String, ByVal Landmark As String, ByRef DispatchZone As String) As String
        Dim PricingZone As String = ""
        Dim sql As String = "apex_geo_getpricezone"
        ...
        Try
            ...
            With Me.Command
                ...
                .Parameters.AddWithValue("@st_no", Val(StNo))
                .Parameters.AddWithValue("@landmark", Landmark)
                .Parameters.AddWithValue("@price_table", Val(PriceTable))

                .Parameters.Add("@dispatch_zone", SqlDbType.VarChar, 10)
                .Parameters.Add("@pricing_zone", SqlDbType.VarChar, 10)

                .Parameters.Item("@dispatch_zone").Direction = ParameterDirection.Output
                .Parameters.Item("@pricing_zone").Direction = ParameterDirection.Output

                .ExecuteNonQuery()

                DispatchZone = Convert.ToString(.Parameters.Item("@dispatch_zone").Value).Trim
                PricingZone = Convert.ToString(.Parameters.Item("@pricing_zone").Value).Trim
        ...
        If IsNumeric(DispatchZone) = False Then
            DispatchZone = "0"
        End If
