...
Partial Class group_orderconfirm
...
#Region "Private Sub"
    ...
    Private Sub OperatorInfo()
        ...
        With objoperatordata
            ...
            '## 3/20/2008   Defautl to "A" if priority is nothing
    ...
    Private Sub insertOperatorInfo()
        Dim MissingConfNoFailedScript As String = "alert('Failed to update, please try again.');window.location='group_orderform.aspx?cno=';"
        ...
        With objoperatordata
            ...
            If objoperatordata.confirmation_no Is Nothing OrElse objoperatordata.confirmation_no.Trim.Length = 0 Then
                ...
                If intresult = 1 Then
                    ...
                    send_mail()
                    Response.Redirect("group_orderconfirmno.aspx?f=" & Me.hdnFrom.Value)
                    'Else
