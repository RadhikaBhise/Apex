...
Partial Class corp_orderconfirm
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'If Not strMsg Is Nothing And strMsg = "nocard" Then
        '    Call Me.AriseJavaScript("'The credit card number you have entered is invalid. Please re-enter the credit card number.'")
        'End If
        ...
        '##modified by joey     2/18/2008
        'Me.btnBack.Attributes.Add("onclick", "document.getElementById('trButton').style.display='none';")
...
#Region "Private Sub"
    ...
    Private Sub OperatorInfo()
        ...
        With objoperatordata
            ...
            '## 3/20/2008   Add priority    (yang)
            '.priority = Convert.ToString(Session("priority"))
            Using users As New Users
                .priority = users.getUserInfo(.vip_no, .account_no, .sub_account_no, .company).priority
    ...
    Private Sub insertOperatorInfo()
        Dim MissingConfNoFailedScript As String = "alert('Failed to update, please try again.');window.location='corp_selectuser.aspx';"
        ...
        With objoperatordata
            ...
            If objoperatordata.confirmation_no Is Nothing OrElse objoperatordata.confirmation_no.Trim.Length = 0 Then
                ...
                If intresult = 1 Then
                    ...
                    send_mail()
                    Response.Redirect("corp_orderconfirmno.aspx?f=" & Me.hdnFrom.Value)
                    'Else
    ...
    '        Dim strLineEnd As String = "&nbsp;<br>"

    '        title = "Your request of confirm #: " & .confirmation_no & " (Please do not reply to this email)"
    '        strBegin = strBegin & "<b>Thank you for booking with APEX.</b><br><br>"
    '        Dim oper As New Operators
    ...
    '        '## 11/21/2007  Disabled by yang
    '        'For i = 0 To 2
    '        '    body = body & mailfields(i) & mailvalues(i) & "<br>"
    '        'Next i
    '        For i = 0 To iCount - 1
    '            body = body & mailfields(i) & mailvalues(i) & "<br>"
    '        Next i

    '        body = body & strLineEnd
    '        strEnd = "" & "<br>" & strLineEnd
    '        body = strBegin & body & strEnd

    '        Dim strReturn As String = ""
    '        strReturn = Business.Mail.SendEmail("", lblEmail.Text.Trim, title, body, True)
