<%@ Page Language="VB" EnableEventValidation="false" MasterPageFile="~/masterPageMenu.master" AutoEventWireup="false" CodeFile="order.aspx.vb" Inherits="order" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="content" runat="server">
    ...
    <form id="form1" runat="server">
        <table id="table1" width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="2">
                    <uc3:orderentry ID="Orderentry1" runat="server" SetUserType="NormalUser" />
                </td>
            </tr>
            <tr>
