<%@ Page Language="VB" MasterPageFile="MasterPagemenu.master" AutoEventWireup="false" CodeFile="orderconfirmno.aspx.vb" Inherits="webride_orderconfirmno" title="Untitled Page" %>
							       ...
							       <table>
										<tr>
											...
											<td valign="top"  align="left" style="display:none">
												...
												<table id="tddirection" cellspacing="2" cellpadding="2" border="0" visible="false">
													<tr>
