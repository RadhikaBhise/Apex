<%@ Page Language="VB" EnableEventValidation="false" MasterPageFile="~/corp_masterpageMenu.master" AutoEventWireup="false" CodeFile="corp_orderform.aspx.vb" Inherits="corp_orderform" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="content" runat="server">
    ...
    <form id="form1" runat="server">
        <table id="table1" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <td colspan="2">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td style="width:70%"><asp:Literal ID="ltrBannerMsg" runat="server"></asp:Literal></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <uc3:orderentry ID="Orderentry1" runat="server" SetUserType="CorporateUser" />
                </td>
            </tr>
            <tr>
