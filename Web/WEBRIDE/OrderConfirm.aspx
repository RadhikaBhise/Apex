<%@ Page Language="VB" MasterPageFile="MasterPageMenu.master" AutoEventWireup="false" Debug="true" CodeFile="OrderConfirm.aspx.vb" Inherits="webride_OrderConfirm" title="Untitled Page" %>
            ...
            <tr>
                <td align="left" > 
                    <table id="tb1" cellspacing="0" cellpadding="0" width="620"  border="0">
                        <tr >                    
                            <td  align="left"  class="css_header">Ride Verification
                            </td>
                        </tr> 
	                    <tr> <!-- Left Margin //-->
		                    <!-- Main Body   //-->
