<%@ Page Language="VB" MasterPageFile="MasterPageQuick.master"  AutoEventWireup="false" CodeFile="quickorderconfirmno.aspx.vb" Inherits="quickorderconfirmno" %>
...
<table id="tb1" cellspacing="0" cellpadding="0" width="620" border="0"  >
            <tr >                    
                <td  align="left" colspan="2">
                    <font class="css_header">Quick Order Completed</font>
                </td>
            </tr> 
	            ...
	            <td>
							       <table>
										<tr>
											<td  align="left" >
												...
												<tr>
														...
														<td class="font2" align="left" ><asp:label id="lblConfirmationNo" Runat="server" ></asp:label><asp:Label ID="lblfullconf" runat="server" Visible="false"></asp:Label></td>
													</tr>
													<tr>
									...
									<%--	<tr>
                                       ...
                                       <tr>
                                           <td colspan="2" class="css_header"><hr />
                                           To Create a profile please enter a user name and password.
                                           </td>
                                       </tr>
										<tr>
										    <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtUserName"
                                                    ErrorMessage="User Name could not be null."></asp:RequiredFieldValidator></td>
										    <td>
										    <table>
										            <tr>
										                <td class="css_desc">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPassword"
                                                    ErrorMessage="Password could not be null."></asp:RequiredFieldValidator></td>
										</tr>										
										<tr>
											<td align="left">
