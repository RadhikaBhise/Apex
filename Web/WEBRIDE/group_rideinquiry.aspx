<%@ Page Language="VB" MasterPageFile="~/group_MasterPageMenu.master" AutoEventWireup="false" CodeFile="group_rideinquiry.aspx.vb" Inherits="group_rideinquiry" title="Untitled Page" %>
        ...
        <table width="700px">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <uc1:rideinquiry ID="Rideinquiry1" runat="server" EnableCancelRide="true" EnableModifyRide="true" EnablePaging="true" OrderModifyPage="group_orderform.aspx" />
                    </ContentTemplate>
				    </asp:UpdatePanel>
                </td>
            </tr>
