<%@ Page Language="VB" MasterPageFile="~/corp_masterpage.master" AutoEventWireup="false" CodeFile="corp_login.aspx.vb" Inherits="corp_login" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="content" Runat="Server">
<%--<table border="0" cellpadding="0" cellspacing="0" >
    <tr>
        <td class="css_header" style="padding-left: 15px">
            Corporate Log In</td>
    </tr>
    <tr>
                    ...
                    <td>
                        <table border="0" cellpadding="2" cellspacing="2">
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
                                        ErrorMessage="please enter the phonenumber!"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="css_desc">
                                    Password</td>
                                <td align="left">
                                    <asp:TextBox ID="txtPwd" runat="server" TextMode="Password" Width="130px"></asp:TextBox><span
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Button ID="btnSubmit" runat="server" Text="Log In"   /></td>
                            </tr>
                        </table>
                    </td>
                </tr>
    ...
    <tr> 
        <td style="color:blue;padding-left: 14px">
            <br />
            <br />
        </td>
    </tr>
