...
Partial Class DayOfReport
    ...
    Public Function GetDataSource() As DataView
        ...
        ' m_dataset = obj_DataSource.GetDayReport(acct_id, sub_acct_id, sel_acct_id, group_flag, strfromdate, strtodate)
    ...
    Protected Sub btnExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExcel.Click
        ...
        Dim strFileName As String = "DayOfReport"
