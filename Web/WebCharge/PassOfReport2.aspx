<%--<%@ Page Language="VB" MasterPageFile="~/MasterPage_New.master" AutoEventWireup="false" CodeFile="PassOfReport2.aspx.vb" Inherits="PassOfReport2" title="Untitled Page" %>
...
<tr>
						...
						<div style="OVERFLOW:auto;width:100%;"><asp:datagrid id="DataGrid_VoucherList"  AllowPaging="true"  runat="server" Font-Names="Arial" Font-Size="Small" ShowFooter="True" PageSize="20"
					...
					<tr>
					<td align="center"><a href="passofreport.aspx">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="rptmenu.aspx">Report Menu</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="default.aspx">Main Menu</a></td>
				</tr>
				<tr>
